...
<section id="content">
  <div class="container">
    <div class="title">Modifier une categorie <a href="Gestion-Categories.php"><button type="button">X</button></a></div>
    ...
    <div class="content">
      <form action="modifiercat.php" method="post" >
        ...
        <div class="button">
          <input type="submit" name="modifiercat" value="Enregistrer">
        </div>
      </form>
    </div>
  </div>
