  ...
  <link rel="shortcut icon" type="x-icon" href="../img/about-img.jpg" />
    ...
    <?php 
      ...
      if(isset($_POST['envoye'])){
        ...
        if($res){
          echo "<script> alert(\"Votre déclaration va etre traité le plustot possible, verifier votre espace regulairement.\")</script>";
          print("<script>window.location.replace('index.php')</script>");
          //print("<script>window.location.replace('smsconfirmation.php?iddec=$res2')</script>");
                  }
    ...
    <form method="post" enctype="multipart/form-data">
      <div>
        ...
        <div>
         ...
         <div>
            <input placeholder="Poid     االوزن " type="number" name="poid" required style="width: 200px; margin-right: 40px;margin-left: 100px;">
        </div>
        <div>
            <input placeholder="Antécedents  &nbsp;&nbsp; خلفية " name="antecedents" style="width: 300px; margin-right: 40px;margin-left: 100px;" required>
          </div>
        </div>
        <!-- -->
        <!-- -->
        ...
        <div>
            <input placeholder="Posologie      الجرعة" type="text" required name="posologie" style="width: 230px; margin-right: 40px;margin-left: 100px;">
        </div>
        </div>
        <!-- -->
        <!-- -->
        ...
        <div>
            ...
            <input  type="date" name="dateF" required style="width: 230px; margin-right: 40px;margin-left: 70px;">
        </div>
        </div>
        ...
        <div>
          <label style="margin-left: 60px;margin-left: 230px;">Insrér une image du produit &nbsp;&nbsp;&nbsp;&nbsp;  أدخل صورة المنتج</label>
          <div>
            <input type="file" name="image_prod" style="width: 300px;margin-left: 60px;margin-left: 240px;" >
          </div>
        </div>
        </div>
        ...
        <div>
          <label style="margin-left: 100px;">Signes cliniques observés  &nbsp;&nbsp; العلامات السريرية لوحظت</label>
          <div>
            <textarea placeholder="" name="signesCL" style="width: 600px; margin-right: 40px;margin-left: 100px;" required></textarea>
          </div>
        </div> 
        </div>
        <div style="display: flex;">
        ...
        <div style="margin-left: 100px;">
            <input placeholder="Délai de survenue      حان الوقت للبدء " type="text" name="delai" required style="width: 240px; margin-right: 40px;">
        </div>
        <div style="margin-left: 100px;">
          <select id style="width: 200px; margin-right: 40px;" name="gravite" required>
        ...
        <div style="margin-left: 100px;">
          <select id style="width: 400px; margin-right: 40px;" name="service" required>
